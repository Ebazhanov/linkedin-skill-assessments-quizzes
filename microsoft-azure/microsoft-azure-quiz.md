...
#### Q73.What are two characteristics of the public cloud? Each correct answer presents a complete solution.
...
#### Q74. Your company hosts an accounting application named App1 that is used by all the customers of the
company. 
...
#### Q75. You plan to migrate a web application to Azure. The web application is accessed by external users. 
...
#### Q76. You have an on-premises network that contains 100 servers. 
...
#### Q77. You plan to migrate several servers from an on-premises network to Azure. 
...
#### Q78. You have 1,000 virtual machines hosted on the Hyper-V hosts in a data center.
...
#### Q79. Your company has an on-premises network that contains multiple servers.
...
#### Q80. A team of developers at your company plans to deploy, and then remove, 50 virtual machines each week. All the virtual machines are configured by using Azure Resource Manager templates.
