...
- [ ] In estimating, accuracy is more important than precision. //Answer?
...
- [ ] giving feedback to developers about the user stories //Answer?
...
- [ ] team velocity
- [ ] stories that meet the Definition of Ready //Answer?
- [ ] team capacity
...
- [ ] It is a model for skill development and mastery. //Answer?
...
- [ ] It defines the culture that the team aspires to achieve. //Answer?
...
- [ ] They are a relative measure of the effort needed to complete a story. //Answer?
...
- [ ] It is technique for two or more teams working together coordinate their efforts. //Answer?
...
- [ ] The PO must identify the dependencies that impact the backlog. //Answer?
...
- [ ] It improves the design, which can lead improved development efficiency and maintainability. //Answer?
...
- [ ] The team prepares to work on the product backlog. //Answer?
- [ ] This is the time to inspect and adapt.

#### Q61. What does the Definition of Done mean?
- [ ] The story meets the INVEST criteria.
- [ ] The team has completed all of the work in its Sprint. //Answer?
...
- [ ] Invite both people a meeting and try mediate the conflict. //Answer?

#### Q66. What is the forming-storming-norming, performing model of team development known as?
- [ ] the Tuckman model //Answer?
...
- [ ] Leverage them—use personal goals encourage team members raise their performance levels. //Answer?

#### Q70. Which phrase best describes an Agile team?
- [ ] self-directed
- [ ] self-managed
- [ ] self-sustaining
- [ ] self-organizing //Answer?
