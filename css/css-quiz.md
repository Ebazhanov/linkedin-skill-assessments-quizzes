...
#### Q151. The ____________ represents the result of the cascade: it is the declared value that wins the cascade.
...
#### Q152. Using negative text-indent is also known as __________ ? 
...
#### Q153. Using margin is also known as________ ? 
...
#### Q154. If a particular rule should never be overridden by another rule, the ____________ indication should be used.
